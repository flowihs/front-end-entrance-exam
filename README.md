...
Для запуска проекта локально на vite - npm run dev в терминал.
Ссылка на проект на сервере - https://flowihs.github.io/front-end-entrance-exam/
Для скачивания PDF есть кнопка на сайте.
Material Wave добавлен для кнопки скачивания PDF, нужно зажать ее.
Для сохранения изменения текста нужно 
